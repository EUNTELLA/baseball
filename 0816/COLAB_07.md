# CatBoost d6·FE10 League-rate 7시드 제출 후보 생성
...
기준 모델의 MR/wayoff 보조모델과 고정 offset은 유지합니다. CatBoost d6·FE10 성공모델만 league-rate baseline 7시드로 교체하고, 기존 전역 logit shift `-0.04163865`는 제거합니다. 2025 baseline은 학습 결과로 확정한 고정값이며 test 평균을 사용하지 않습니다.
