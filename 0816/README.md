...
## 09. 공식 train 추세 기반 고정 shift 제출본

외부 자료 없이 공식 `train.csv`의 시즌별 성공률만 사용합니다. 2022~2024 walk-forward에서 다음 시즌 변화량 반영 비율 `alpha`를 `0.00~1.00`으로 비교하고 MSE가 가장 낮은 값을 고정합니다.

```text
rate_2025 = rate_2024 + alpha × (rate_2024 - rate_2023)
```
