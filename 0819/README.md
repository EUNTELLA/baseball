...
- 후보 2023 BSS 증분: `+4.5534`
- 후보 2024 BSS 증분: `+59.9253`
- 현재 3종 구성: 2023 `+8.6274`, 2024 `+57.3687`
- 후보의 현재 구성 대비 변화: 2023 `-4.0740`, 2024 `+2.5566`
- 평균 증분: 후보 `+32.2394`, 현재 구성 `+32.9981`
- 최악 시즌 증분: 후보 `+4.5534`, 현재 구성 `+8.6274`
- 판정: 새 ZIP을 만들지 않고 Public `1029.0832235020` 유지

스크립트의 자동 판정은 무보정 기준 통과 여부만 검사합니다. 최종 선택에서는 현재 최고 구성과 직접 비교하며, 평균과 최악 시즌이 모두 낮아진 이번 후보는 보류합니다.
...
- 현재 최고 `1029.0832235020` 대비: `-0.2115220615`
- 판정: 폐기
- 결론: 로컬 2024의 작은 하락과 같은 방향으로 리더보드도 하락해 F 행 큰 이탈 보조 신호의 단순 추가를 종료
